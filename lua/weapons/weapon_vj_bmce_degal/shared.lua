...
SWEP.PrintName					= ".44 Desert Eagle"
SWEP.Author 					= "Pyri"
...
SWEP.UseHands 				= false
	...
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.ViewModel					= "models/weapons/viewmodels/bmce/v_357.mdl"
SWEP.WorldModel					= "models/weapons/bmce_weapons/bmce_degal/w_357.mdl"
...
SWEP.NPC_TimeUntilFireExtraTimers = {0.7,1.4,2.1} -- Next time it can use primary fire
...
SWEP.NPC_ReloadSound			= {"vj_bmce/weapons/bmce_degal/reload.mp3"} -- Sounds it plays when the base detects the SNPC playing a reload animation
	-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage				= 27 -- Damage
SWEP.Primary.PlayerDamage		= 27 -- Only applies for players | "Same" = Same as self.Primary.Damage, "Double" = Double the self.Primary.Damage OR put a number to be different from self.Primary.Damage
SWEP.Primary.Force				= 1.6 -- Force applied on the object the bullet hits
SWEP.Primary.ClipSize			= 8 -- Max amount of bullets per clip
SWEP.Primary.Recoil				= 1.5 -- How much recoil does the player get?
SWEP.Primary.Delay				= 0.43 -- Time until it can shoot again
SWEP.Primary.Automatic			= true -- Is it automatic?
SWEP.Primary.Ammo				= "357" -- Ammo type
SWEP.Primary.Sound				= {"vj_bmce/weapons/bmce_degal/close.mp3"}
SWEP.Primary.HasDistantSound	= true -- Does it have a distant sound when the gun is shot?
SWEP.Primary.DistantSound		= {"vj_bmce/weapons/bmce_degal/distant.mp3"}
...
SWEP.ReloadSound				= "vj_bmce/weapons/bmce_degal/reload_player.mp3"
...
if CLIENT then
	...
	local aimPos = Vector(-1, -1, 0)
	local aimAng = Angle(1, 2, 0)
	---------------------------------------------------------------------------------------------------------------------------------------------
